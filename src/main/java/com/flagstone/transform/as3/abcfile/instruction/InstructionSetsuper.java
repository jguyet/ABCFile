...
public class InstructionSetsuper
extends Instruction {
    public static final ABCLogger LOGGER = new ABCLogger(InstructionSetsuper.class);
    public static final Opcode opcode = Opcode.OP_setsuper;
    protected int index;

    public InstructionSetsuper(ByteBufferFlash date, int position) {
    ...
    public InstructionSetsuper(int index, int position) {
        super(opcode);
        this.index = index;
    }

    public InstructionSetsuper() {
        super(opcode);
    }
