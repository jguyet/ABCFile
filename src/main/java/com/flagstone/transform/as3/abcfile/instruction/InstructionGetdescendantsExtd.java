...
public class InstructionGetdescendantsExtd
extends InstructionGetdescendants {
    private MultinameInfo multiname_info;
    protected CpoolInfo cpool;

    public InstructionGetdescendantsExtd(ByteBufferFlash date, int position, CpoolInfo cpool) {
        super(date, position);
        this.cpool = cpool;
        this.multiname_info = ((MultinameInfo) cpool.getMultinames().get(this.index));
    }

    public InstructionGetdescendantsExtd(MultinameInfo multiname_info, int position) {
