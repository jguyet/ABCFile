...
public class InstructionDeletepropertyExtd
extends InstructionDeleteproperty {
    private MultinameInfo multiname_info;
    protected CpoolInfo cpool;

    public InstructionDeletepropertyExtd(ByteBufferFlash date, int position, CpoolInfo cpool) {
        super(date, position);
        this.cpool = cpool;
        this.multiname_info = ((MultinameInfo) cpool.getMultinames().get(this.index));
    }

    public InstructionDeletepropertyExtd(MultinameInfo multiname_info, int position) {
