...
public class InstructionSetproperty
extends Instruction {
    public static final ABCLogger LOGGER = new ABCLogger(InstructionSetproperty.class);
    public static final Opcode opcode = Opcode.OP_setproperty;
    protected int index;

    public InstructionSetproperty(ByteBufferFlash date, int position) {
    ...
    public InstructionSetproperty(int index, int position) {
        super(opcode);
        this.index = index;
    }

    public InstructionSetproperty() {
        super(opcode);
    }
